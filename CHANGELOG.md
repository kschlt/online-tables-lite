...
- Improve commit workflow validation and staging decision handling
- Remove unnecessary promptlet from no-changes terminal condition
...
- Integrate staging into commit workflow for streamlined UX
- Implement 2B PR workflow with orchestrator pattern
...
- Remove test file
- Add test file for validation check
